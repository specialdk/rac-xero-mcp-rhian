...
class ProjectApi {
     ...
     */
    createProject(xeroTenantId, projectCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    createTask(xeroTenantId, projectId, taskCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    createTimeEntry(xeroTenantId, projectId, timeEntryCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    patchProject(xeroTenantId, projectId, projectPatch, idempotencyKey, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Projects/{projectId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
            let localVarQueryParameters = {};
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    updateProject(xeroTenantId, projectId, projectCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Projects/{projectId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
            let localVarQueryParameters = {};
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    updateTask(xeroTenantId, projectId, taskId, taskCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Projects/{projectId}/Tasks/{taskId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
                .replace('{' + 'taskId' + '}', encodeURIComponent(String(taskId)));
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    updateTimeEntry(xeroTenantId, projectId, timeEntryId, timeEntryCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Projects/{projectId}/Time/{timeEntryId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
                .replace('{' + 'timeEntryId' + '}', encodeURIComponent(String(timeEntryId)));
