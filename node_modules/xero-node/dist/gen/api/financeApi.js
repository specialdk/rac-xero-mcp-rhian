...
})(FinanceApiApiKeys || (exports.FinanceApiApiKeys = FinanceApiApiKeys = {}));
class FinanceApi {
     ...
     */
    getBankStatementAccounting(xeroTenantId, bankAccountID, fromDate, toDate, summaryOnly, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (bankAccountID !== undefined) {
                localVarQueryParameters['BankAccountID'] = models_1.ObjectSerializer.serialize(bankAccountID, "string");
            }
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "BankStatementAccountingResponse");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
