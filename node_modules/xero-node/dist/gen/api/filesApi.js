...
})(FilesApiApiKeys || (exports.FilesApiApiKeys = FilesApiApiKeys = {}));
class FilesApi {
     ...
     * @param association
     */
    createFileAssociation(xeroTenantId, fileId, idempotencyKey, association, options = { headers: {} }) {
     ...
     * @param folder
     */
    createFolder(xeroTenantId, idempotencyKey, folder, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    getAssociationsByObject(xeroTenantId, objectId, pagesize, page, sort, direction, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (sort !== undefined) {
                localVarQueryParameters['sort'] = models_1.ObjectSerializer.serialize(sort, "'Name' | 'CreatedDateUTC'");
            }
     ...
     */
    getAssociationsCount(xeroTenantId, objectIds, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (objectIds !== undefined) {
                localVarQueryParameters['ObjectIds'] = models_1.ObjectSerializer.serialize(objectIds, "Array<string>");
            }
            localVarHeaderParams['xero-tenant-id'] = models_1.ObjectSerializer.serialize(xeroTenantId, "string");
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
     ...
     * @param fileObject
     */
    updateFile(xeroTenantId, fileId, idempotencyKey, fileObject, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Files/{FileId}'
                .replace('{' + 'FileId' + '}', encodeURIComponent(String(fileId)));
            let localVarQueryParameters = {};
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    updateFolder(xeroTenantId, folderId, folder, idempotencyKey, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Folders/{FolderId}'
                .replace('{' + 'FolderId' + '}', encodeURIComponent(String(folderId)));
            let localVarQueryParameters = {};
     ...
     * @param mimeType
     */
    uploadFile(xeroTenantId, body, name, filename, idempotencyKey, mimeType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Files';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param mimeType
     */
    uploadFileToFolder(xeroTenantId, folderId, body, name, filename, idempotencyKey, mimeType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
